...
# NOTE: This GUI is partially generated by wxFormBuilder
class MacInfo(wx.Frame):

    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title="Mac Info", pos=wx.DefaultPosition, size=wx.Size(-1, -1),
        ...
        # Create menu items
        self.m_menuItem_file_start_scan = wx.MenuItem(self.m_menu_File, wx.ID_ANY, "Start Scan", wx.EmptyString,
                                                      wx.ITEM_NORMAL)

        self.m_menuItem_file_close = wx.MenuItem(self.m_menu_File, wx.ID_ANY, "Close", wx.EmptyString,
                                                 wx.ITEM_NORMAL)

        self.m_menuItem_help_About = wx.MenuItem(self.m_menu_help, wx.ID_ANY, "About", wx.EmptyString,
                                                 wx.ITEM_NORMAL)
        ...
        self.m_menubar.Append(self.m_menu_File, "File")
        self.m_menubar.Append(self.m_menu_help, "Help")
        ...
        self.m_staticText_name_of_module = wx.StaticText(self.m_panel, wx.ID_ANY, "Mac Info", wx.DefaultPosition,
        ...
        self.m_staticText_d = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Date : ",
        ...
        self.m_staticText9 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Serial Number : ",
                                           wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_staticText2 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Model Info : ", wx.DefaultPosition,
                                           wx.Size(150, -1), 0)
        ...
        self.m_staticText4 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Processor : ", wx.DefaultPosition,
                                           wx.Size(150, -1), 0)
        ...
        self.m_staticText5 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "RAM Info : ", wx.DefaultPosition,
                                           wx.Size(150, -1), 0)
        ...
        self.m_staticText7 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Storage Media : ",
                                           wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_staticText8 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Graphic Card : ",
                                           wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_staticText18 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Optical Drive : ",
                                            wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_staticText10 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Battery Status : ",
                                            wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_staticText_operating_system = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Wireless Card : ",
                                                           wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_staticText21 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Bluetooth : ", wx.DefaultPosition,
                                            wx.Size(150, -1), 0)
        ...
        self.m_staticText22 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Ethernet : ", wx.DefaultPosition,
                                            wx.Size(150, -1), 0)
        ...
        self.m_staticText23 = wx.StaticText(self.m_panel_basic_hardware, wx.ID_ANY, "Operating System : ",
                                            wx.DefaultPosition, wx.Size(150, -1), 0)
        ...
        self.m_notebook.AddPage(self.m_panel_basic_hardware, "Basic Hardware", False)

        bSizer_bookSizer.Add(self.m_notebook, 1, wx.EXPAND | wx.ALL, 5)

        self.m_button_reset = wx.Button(self, wx.ID_ANY, "Reset", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer_buttonSizer.Add(self.m_button_reset, 0, wx.ALL | wx.SHAPED, 5)

        self.m_button_start_scan = wx.Button(self, wx.ID_ANY, "Start Scan", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        randomId = wx.NewId()
        self.Bind(wx.EVT_MENU, self.on_ctrl_q, id=randomId)
